...
|---|---|---|---|
| **1** | Montar CI | **Antes del Loop E**, PR aparte a `Desarrollo` | Si entra primero, el PR del Loop E se verifica solo. No toca la app ni tiene contenido clínico: no necesita loop |
